    ...
    public class OpenAIController : Controller
    {
        ...
        public async Task<IActionResult> GetAnswer(string question)
        {
            var predefinedAnswers = new Dictionary<string, string>
            {
                ...
                { "¿Cómo puedo programar una cita?", "1-Iniciar Sesión en el sistema." + "   " +
                "2. Presionar la sección de servicios." +
                "3. Presionar la casilla de Gestionar Citas." +
                "4. Llenar el formulario" +
                "5. Presionar el botón para enviar el formulario" +
                "6. Esperar a la valoración de tu cita." }
            };
            ...
            if (question == "¿Dónde está ubicado el taller?")
            {
                ...
                var response = $"Estamos ubicados en 100 sur, 25 oeste de la entrada de emergencias Maternidad Carit. <a href='{googleMapsLink}' target='_blank'>Ver en Google Maps</a>";
