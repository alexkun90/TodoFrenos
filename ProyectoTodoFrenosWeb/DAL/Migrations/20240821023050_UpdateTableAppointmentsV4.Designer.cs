...
namespace DAL.Migrations
{
    ...
    [Migration("20240821023050_UpdateTableAppointmentsV4")]
    partial class UpdateTableAppointmentsV4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Appointment", b =>
                {
                    ...
                    b.Property<int?>("ReadMyAppointment")
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("StateAppointment")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DAL.Models.Deducciones", b =>
                {
                    ...
                    b.Property<long>("NominaDetalleId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DAL.Models.Employee", b =>
                {
                    ...
                    b.Property<int?>("CantDiasLaborales")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.PlayrollDetail", b =>
                {
                    b.Property<long>("NominaDetalleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("NominaDetalleId"));
            ...
            modelBuilder.Entity("DAL.Models.Deducciones", b =>
                {
                    b.HasOne("DAL.Models.PlayrollDetail", "PlayrollDetail")
                        .WithMany()
                        .HasForeignKey("NominaDetalleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlayrollDetail");
                });
